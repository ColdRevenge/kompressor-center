...
define("EDOST_ID", 5441); //Идентификатор магазина (вписать вместо: 0)
define("EDOST_PSWD", "XZ8xACBPJtY33c29iuw278JipHZXMpHH"); //Пароль для доступа к серверу расчетов (вписать вместо: password)
//---------- ВНИМАНИЕ!!! ----------
