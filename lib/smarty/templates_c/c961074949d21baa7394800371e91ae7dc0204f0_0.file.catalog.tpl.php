<?php /* Smarty version 3.1.24, created on 2015-12-15 16:12:46
         compiled from "/home/c10045/public_html/kompressor-center.com/modules/catalog/templates/catalog.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:1996034237567011ce109152_28530550%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c961074949d21baa7394800371e91ae7dc0204f0' => 
    array (
      0 => '/home/c10045/public_html/kompressor-center.com/modules/catalog/templates/catalog.tpl',
      1 => 1450185165,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1996034237567011ce109152_28530550',
  'variables' => 
  array (
    'is_main' => 0,
    'is_ajax' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_567011ce353643_38778405',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_567011ce353643_38778405')) {
function content_567011ce353643_38778405 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '1996034237567011ce109152_28530550';
?>
...
?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['content_text']->value) {?><div style="margin-bottom: 10px;"><?php echo $_smarty_tpl->tpl_vars['content_text']->value;?>
</div><?php }?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['categoryes']->value[$_smarty_tpl->tpl_vars['category_id']->value]) {?>
                <div  id="catalog-group">
                    <div id="category-group">
                        <?php
$_from = $_smarty_tpl->tpl_vars['categoryes']->value[0];
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
$_smarty_tpl->tpl_vars["icategory"] = new Smarty_Variable;
...
?>
        ...
        <?php } elseif ($_smarty_tpl->tpl_vars['category_id']->value != 0 || $_smarty_tpl->tpl_vars['is_find']->value == 1) {?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['is_category']->value != 1) {?>   
                ...
                <?php }?> 
            <?php } elseif (!(count($_smarty_tpl->tpl_vars['child_categoryes']->value)) && $_smarty_tpl->tpl_vars['open_category_id']->value != 0) {?>
                <h3>Нет товаров</h3>
            <?php }?>
