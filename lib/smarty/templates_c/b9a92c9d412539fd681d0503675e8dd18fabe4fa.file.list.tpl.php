<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-08-21 18:46:36
         compiled from "/home/lalipop/domains/lalipop.ru/public_html/modules/selection/templates/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:190412136055d747dca5ab26-59711603%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b9a92c9d412539fd681d0503675e8dd18fabe4fa' => 
    array (
      0 => '/home/lalipop/domains/lalipop.ru/public_html/modules/selection/templates/list.tpl',
      1 => 1423307974,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '190412136055d747dca5ab26-59711603',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55d747dcb70559_53224203',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55d747dcb70559_53224203')) {function content_55d747dcb70559_53224203($_smarty_tpl) {?><div class="block">
    <div class="menu">
        <h1>Подбор для:</h1>
        ...
        <form method="post" enctype="multipart/form-data" action="">
            <?php if (count($_smarty_tpl->tpl_vars['get_chars']->value)) {?>
                ...
                <table cellpadding="5" cellspacing="1" border="0" class="table" width="100%">
                    ...
                    <?php  $_smarty_tpl->tpl_vars["get_char"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["get_char"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['get_chars']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["get_char"]->key => $_smarty_tpl->tpl_vars["get_char"]->value) {
...
" <?php if ($_POST[$_smarty_tpl->tpl_vars['char_id']->value]['char_id']==$_smarty_tpl->tpl_vars['get_char']->value->char_id||$_smarty_tpl->tpl_vars['char']->value->id==$_smarty_tpl->tpl_vars['get_char']->value->char_id) {?>selected="selected"<?php }?>><?php echo stripslashes($_smarty_tpl->tpl_vars['char']->value->name);?>
                                ...
                                <td valign="middle" align="center">
                                    <select name="type[<?php echo $_smarty_tpl->tpl_vars['char_id']->value;?>
                                        ...
                                        <option value="2" <?php if ($_POST[$_smarty_tpl->tpl_vars['char_id']->value]['type']==2||$_smarty_tpl->tpl_vars['get_char']->value->type==2) {?>selected="selected"<?php }?>>Переключатели</option>
                                    </select>
                                </td>     
...
"><?php echo stripslashes($_smarty_tpl->tpl_vars['char']->value->name);?>
                        ...
                        <td valign="middle" align="center">
                            <select name="type">
                                ...
                                <option value="2">Переключатели</option>
                            </select>
                        </td>     
