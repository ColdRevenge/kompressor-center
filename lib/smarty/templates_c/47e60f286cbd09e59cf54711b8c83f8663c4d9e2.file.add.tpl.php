<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-09-08 16:56:32
         compiled from "/home/lalipop/domains/lalipop.ru/private_html/modules/products/templates/add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:148622810655d46a6614d8a7-95213330%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '47e60f286cbd09e59cf54711b8c83f8663c4d9e2' => 
    array (
      0 => '/home/lalipop/domains/lalipop.ru/private_html/modules/products/templates/add.tpl',
      1 => 1441720589,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '148622810655d46a6614d8a7-95213330',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_55d46a664128a5_49971453',
  'variables' => 
  array (
    'temp_image_id' => 0,
    'visual_editor' => 0,
...
<?php if ($_valid && !is_callable('content_55d46a664128a5_49971453')) {function content_55d46a664128a5_49971453($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/lalipop/domains/lalipop.ru/public_html/lib/smarty/plugins/modifier.replace.php';
?>
<?php if ($_GET['is_modal']!=1) {?>
    <div class="block">
        <div class="menu">
            <?php echo $_smarty_tpl->getSubTemplate ("_menu_products_add.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('temp_image_id'=>$_smarty_tpl->tpl_vars['temp_image_id']->value), 0);?>
                ...
                <tr>
                    ...
                    <td valign="middle" align="left">
                        <select name="category_1_id" style="width:550px;">
                            ...
                            <?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['select_tree_file']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>0,'tree'=>$_smarty_tpl->tpl_vars['category']->value,'inc'=>$_smarty_tpl->tpl_vars['select_tree_file']->value,'level'=>0,'selected_id'=>$_POST['category_1_id']), 0);?>
                ...
                <tr>
                    ...
                    <td valign="middle" align="left">
                        <select name="category_2_id" style="width:550px;">
                            <option value="0">...</option>
                            <?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['select_tree_file']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>0,'tree'=>$_smarty_tpl->tpl_vars['category']->value,'inc'=>$_smarty_tpl->tpl_vars['select_tree_file']->value,'level'=>0,'selected_id'=>$_POST['category_2_id']), 0);?>
                    ...
                    <tr>
                        ...
                        <td valign="middle" align="left">
                            <select name="category_3_id" style="width:550px;" >
                                <option value="0">...</option>
                                <?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['select_tree_file']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>0,'tree'=>$_smarty_tpl->tpl_vars['category']->value,'inc'=>$_smarty_tpl->tpl_vars['select_tree_file']->value,'level'=>0,'selected_id'=>$_POST['category_3_id']), 0);?>
                    ...
                    <tr>
                        ...
                        <td valign="middle" align="left">
                            <select name="category_4_id" style="width:550px;" >
                                <option value="0">...</option>
                                <?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['select_tree_file']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>0,'tree'=>$_smarty_tpl->tpl_vars['category']->value,'inc'=>$_smarty_tpl->tpl_vars['select_tree_file']->value,'level'=>0,'selected_id'=>$_POST['category_4_id']), 0);?>
                ...
                <tr>
                    ...
                    <td valign="middle" align="left">
                        <select name="category_5_id" style="width:550px;" >
                            <option value="0">...</option>
                            <?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['select_tree_file']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>0,'tree'=>$_smarty_tpl->tpl_vars['category']->value,'inc'=>$_smarty_tpl->tpl_vars['select_tree_file']->value,'level'=>0,'selected_id'=>$_POST['category_5_id']), 0);?>
...
" maxlength="255" style="width: 400px;vertical-align: middle;"/>
                ...
                <?php if ($_smarty_tpl->tpl_vars['is_multi_mod']->value==0) {?>
                    ...
                    <?php echo $_smarty_tpl->getSubTemplate ("mod_list_row.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

                <?php } else { ?>
                    
                    <?php echo $_smarty_tpl->getSubTemplate ("mod_list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
" onchange="if ($(this).find('option:selected').val() != 0) {
 ...
 $_from = $_smarty_tpl->tpl_vars['values']->value[$_smarty_tpl->tpl_vars['characteristic_id']->value]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
images/sys/<?php if ($_smarty_tpl->tpl_vars['selected_value_id']->value) {?>edit<?php } else { ?>add<?php }?>.gif" align="middle" hspace="1" alt="Редактировать"></a>
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']["char_check"]['total'] = $_smarty_tpl->tpl_vars["value"]->total;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']["char_check"]['iteration']=0;
foreach ($_from as $_smarty_tpl->tpl_vars["value"]->key => $_smarty_tpl->tpl_vars["value"]->value) {
$_smarty_tpl->tpl_vars["value"]->_loop = true;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']["char_check"]['iteration']++;
?>
                                                    <?php $_smarty_tpl->tpl_vars["char_value_id"] = new Smarty_variable($_smarty_tpl->tpl_vars['value']->value->id, null, 0);?>
                                                    <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['char_check']['iteration']%(ceil($_smarty_tpl->getVariable('smarty')->value['foreach']['char_check']['total']/3))==1) {?><div style="float: left"><?php }?>
...
" /><em<?php if ($_smarty_tpl->tpl_vars['characteristic_id']->value==56) {?> style="margin-right: 3px;"<?php }?>>&nbsp;</em><span><?php echo stripslashes($_smarty_tpl->tpl_vars['value']->value->name);?>
                                                        ...
                                                        <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['char_check']['iteration']%(ceil($_smarty_tpl->getVariable('smarty')->value['foreach']['char_check']['total']/3))==0) {?></div><?php }?>
                                                    <?php } ?>
                                                <?php } else { ?> 
                    ...
                    <tr>
                        ...
                        <td valign="middle" align="left">
                            <table cellpadding="1" cellspacing="1" border="0" class="table" width="529">
                                ...
                                <?php  $_smarty_tpl->tpl_vars["characteristic"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["characteristic"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['characteristics_tech']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["characteristic"]->key => $_smarty_tpl->tpl_vars["characteristic"]->value) {
$_smarty_tpl->tpl_vars["characteristic"]->_loop = true;
?>
                                        ...
                                        <tbody class="tbody">
                                            ...
                                            <tr>
                                                <td valign="middle" align="left">
                                                    ...
                                                    <?php  $_smarty_tpl->tpl_vars["value"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["value"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['values_tech']->value[$_smarty_tpl->tpl_vars['characteristic_id']->value][0]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["value"]->key => $_smarty_tpl->tpl_vars["value"]->value) {
$_smarty_tpl->tpl_vars["value"]->_loop = true;
?>
 ...
 $_from = $_smarty_tpl->tpl_vars['values_tech']->value[$_smarty_tpl->tpl_vars['characteristic_id']->value][$_smarty_tpl->tpl_vars['parent_id']->value]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" style="width: 680px;"/>
 ...
 type="text/javascript">
        ...
        <?php echo '</script'; ?>
>
        <?php if ($_GET['is_modal']!=1) {?></div><?php }?><?php }} ?>
