...
<?php
/*%%SmartyHeaderCode:209448531755f574444965a2_66967377%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd56a618c7ec1588e7416207b266307a90daee125' => 
    array (
  ...
  'nocache_hash' => '209448531755f574444965a2_66967377',
  'variables' => 
  array (
    'shop' => 0,
    'product' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_55f5744470d060_38581665',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_55f5744470d060_38581665')) {
function content_55f5744470d060_38581665 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '209448531755f574444965a2_66967377';
if ($_smarty_tpl->tpl_vars['shop']->value == 'lady' || $_smarty_tpl->tpl_vars['shop']->value == 'woman') {?>
                                        ...
                                        <?php if ($_smarty_tpl->tpl_vars['mod']->value->warehouse > 0 && $_smarty_tpl->tpl_vars['product']->value->is_active == 1) {?>    
                                            <?php if ($_smarty_tpl->tpl_vars['shop']->value == 'lady' || $_smarty_tpl->tpl_vars['shop']->value == 'woman') {?>
                                                <div class="size-block">
                                                    ...
                                                    <ul>
                                                        <?php
$_from = $_smarty_tpl->tpl_vars['characteristics_size_value']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
...
" <?php if ((isset($_smarty_tpl->tpl_vars['__foreach_char_size']->value['iteration']) ? $_smarty_tpl->tpl_vars['__foreach_char_size']->value['iteration'] : null) == 1) {?> checked="checked"<?php }?>  onchange="setPriceSize('<?php echo $_smarty_tpl->tpl_vars['size_price']->value[$_smarty_tpl->tpl_vars['char_size_id']->value];?>
...
?>
                                                    ...
                                                    <?php echo $_smarty_tpl->getSubTemplate ('like_product_mobile.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('products_in_category'=>$_smarty_tpl->tpl_vars['products_in_category']->value,'type'=>"1"), 0);
?>

                                                    <?php echo $_smarty_tpl->getSubTemplate ('like_product_mobile.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('products_in_category'=>$_smarty_tpl->tpl_vars['complect_products']->value,'type'=>"2"), 0);
?>
                                                    ...
                                                    <?php if (count($_smarty_tpl->tpl_vars['related_products']->value[0]) > 0) {?>
                                                        <li><a  href="javascript:void(0)" class="slideParamProduct complect-icon">Товары из комплекта</a>
                                                            <div style="display: none;">
                                                                <?php echo $_smarty_tpl->getSubTemplate (($_smarty_tpl->tpl_vars['base_dir']->value).('modules/catalog/templates/getProductMobile.tpl'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('products'=>$_smarty_tpl->tpl_vars['related_products']->value,'product_images'=>$_smarty_tpl->tpl_vars['related_product_images']->value), 0);
?>

                                                            </div>
                                                        </li>
                                                    <?php }?>
                                                    <?php echo $_smarty_tpl->getSubTemplate ('history_product_mobile.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0);
?>
