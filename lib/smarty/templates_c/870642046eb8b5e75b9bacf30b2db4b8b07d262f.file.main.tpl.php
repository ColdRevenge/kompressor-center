<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-09-11 15:56:58
         compiled from "/home/lalipop/domains/lalipop.ru/private_html/templates/main.tpl" */ ?>
<?php /*%%SmartyHeaderCode:35939628855d4694b808cc7-81857409%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '870642046eb8b5e75b9bacf30b2db4b8b07d262f' => 
    array (
  ...
  'nocache_hash' => '35939628855d4694b808cc7-81857409',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_55d4694ba71b42_79742629',
  'variables' => 
  array (
    'shop' => 0,
    'is_mobile' => 0,
...
<?php if ($_valid && !is_callable('content_55d4694ba71b42_79742629')) {function content_55d4694ba71b42_79742629($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/lalipop/domains/lalipop.ru/public_html/lib/smarty/plugins/modifier.date_format.php';
...
if ($_GET['is_modal']!=1) {
echo $_smarty_tpl->getSubTemplate ("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
podbor-header.png" alt="" id="catalog-header" />
                                <div class="catalog-bg">
                                    ...
                                    <?php echo $_smarty_tpl->getSubTemplate ("podbor.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
            ...
            <div id="content-box"<?php if ($_smarty_tpl->tpl_vars['param_tpl']->value['module']=='stat') {?> style="float: none; width: 1000px;"<?php }?>>
                <?php if (count($_smarty_tpl->tpl_vars['banners_list']->value)>0) {?>
                    <div id="slider">
                        <div class="slider">
                            <ul>
                                <?php  $_smarty_tpl->tpl_vars["bann_item"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["bann_item"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['banners_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["bann_item"]->key => $_smarty_tpl->tpl_vars["bann_item"]->value) {
...
bizhuteriya/">Каталог бижутерии</a><?php }?></div>
 ...
 $_from = $_smarty_tpl->tpl_vars['tree']->value[0]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" />
 ...
 $_from = $_smarty_tpl->tpl_vars['tree']->value[$_smarty_tpl->tpl_vars['icategory_id']->value]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
