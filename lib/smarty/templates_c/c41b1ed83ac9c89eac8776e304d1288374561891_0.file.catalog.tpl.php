<?php /* Smarty version 3.1.24, created on 2017-01-28 02:33:09
         compiled from "/var/www/user-kc-pskov/data/www/kc-pskov.ru/modules/catalog/templates/catalog.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:1211308273588bd8b554b222_72940906%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c41b1ed83ac9c89eac8776e304d1288374561891' => 
    array (
      0 => '/var/www/user-kc-pskov/data/www/kc-pskov.ru/modules/catalog/templates/catalog.tpl',
      1 => 1485559640,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1211308273588bd8b554b222_72940906',
  'variables' => 
  array (
    'is_main' => 0,
    'is_ajax' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_588bd8b581faf0_08441954',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_588bd8b581faf0_08441954')) {
function content_588bd8b581faf0_08441954 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '1211308273588bd8b554b222_72940906';
?>
...
?>
                <?php if ($_smarty_tpl->tpl_vars['brand_name']->value && !count($_smarty_tpl->tpl_vars['bread_page_arr']->value)) {?>
                    <li><?php echo $_smarty_tpl->tpl_vars['brand_name']->value;?>
</li>
                <?php }?>
...
?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['brand_name']->value) {?>
            <h1><?php echo stripslashes($_smarty_tpl->tpl_vars['brand_name']->value);?>
</h1>
        <?php } elseif ($_smarty_tpl->tpl_vars['is_find']->value == 1) {?>
            <h1>Поиск товаров - "<?php echo preg_replace('!<[^>]*?>!', ' ', stripslashes($_GET['find']));?>
"</h1>
        <?php } else { ?>
            <h1>
...
?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['categoryes']->value[$_smarty_tpl->tpl_vars['category_id']->value]) {?>
            <?php echo $_smarty_tpl->getSubTemplate ('getCategoriesList.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('categoriesList'=>$_smarty_tpl->tpl_vars['categoryes']->value[$_smarty_tpl->tpl_vars['category_id']->value]), 0);
?>
