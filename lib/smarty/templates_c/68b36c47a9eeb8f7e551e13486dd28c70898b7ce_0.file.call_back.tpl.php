<?php /* Smarty version 3.1.24, created on 2018-07-17 11:38:11
         compiled from "/var/www/user-kc/data/www/www.kompressor-center.com/modules/call_back/templates/call_back.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:20259946375b4daaf309a9f8_72840882%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '68b36c47a9eeb8f7e551e13486dd28c70898b7ce' => 
    array (
      0 => '/var/www/user-kc/data/www/www.kompressor-center.com/modules/call_back/templates/call_back.tpl',
      1 => 1530509442,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20259946375b4daaf309a9f8_72840882',
  'variables' => 
  array (
    'message' => 0,
    'error' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_5b4daaf3307f37_36839940',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5b4daaf3307f37_36839940')) {
function content_5b4daaf3307f37_36839940 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '20259946375b4daaf309a9f8_72840882';
?>
<?php echo '<script'; ?>
 type="text/javascript" src="https://www.google.com/recaptcha/api.js?onload=recaptchaCallBack&render=explicit&hl=ru"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
>
...
" name="phone"  id="phone_id" placeholder="Ваш телефон"/></div>
                ...
                <div style="position: relative">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['err_massage']->value == 2) {?> <div style="color: red; font-size: 12px; position: absolute; bottom : -22px; left: 0;">Рекаптча решена неверно</div><?php }?>
                </div>
...
call_back/mini/');"><?php echo $_smarty_tpl->tpl_vars['err_str']->value;?>
        ...
        <?php } elseif ($_smarty_tpl->tpl_vars['error']->value) {?>
            <h2 style="color: red; margin-top: 25px;"><?php echo $_smarty_tpl->tpl_vars['error']->value;?>
</h2>
        <?php }?>
</div>
<?php }
