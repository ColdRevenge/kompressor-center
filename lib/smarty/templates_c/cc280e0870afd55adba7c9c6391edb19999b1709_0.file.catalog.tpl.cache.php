<?php /* Smarty version 3.1.24, created on 2015-09-13 16:07:07
         compiled from "/home/lalipop/domains/lalipop.ru/private_html/modules/catalog/templates/catalog.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:122227793155f574fb31dcc9_44490337%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cc280e0870afd55adba7c9c6391edb19999b1709' => 
    array (
      0 => '/home/lalipop/domains/lalipop.ru/private_html/modules/catalog/templates/catalog.tpl',
      1 => 1440256266,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '122227793155f574fb31dcc9_44490337',
  'variables' => 
  array (
    'is_mobile' => 0,
    'is_main' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_55f574fb5b32c8_10115778',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_55f574fb5b32c8_10115778')) {
function content_55f574fb5b32c8_10115778 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '122227793155f574fb31dcc9_44490337';
if ($_smarty_tpl->tpl_vars['is_mobile']->value == 1) {
echo $_smarty_tpl->getSubTemplate ("catalog_mobile.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array(), 0);
} else { ?>
...
<?php if ($_smarty_tpl->tpl_vars['not_podbor']->value != 1 && ($_smarty_tpl->tpl_vars['shop']->value == 'lady' || $_smarty_tpl->tpl_vars['shop']->value == 'woman') && $_smarty_tpl->tpl_vars['is_find']->value != 1) {?>
    <?php echo $_smarty_tpl->getSubTemplate ("podbor_lady.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array(), 0);
?>
...
<?php if ($_smarty_tpl->tpl_vars['not_podbor']->value != 1 && ($_smarty_tpl->tpl_vars['shop']->value == 'sumka') && $_smarty_tpl->tpl_vars['is_find']->value != 1) {?>
    <?php echo $_smarty_tpl->getSubTemplate ("podbor_sumka.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array(), 0);
?>
...
<?php if ($_smarty_tpl->tpl_vars['user_id']->value == 446 && $_smarty_tpl->tpl_vars['is_brand']->value != 1 && $_smarty_tpl->tpl_vars['is_ajax']->value != 1) {?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['shop']->value == 'lady' || $_smarty_tpl->tpl_vars['shop']->value == 'woman') {?>
        <?php echo $_smarty_tpl->getSubTemplate ("podbor_char_lady.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array(), 0);
?>

    <?php } elseif ($_smarty_tpl->tpl_vars['shop']->value == 'sumka') {?>
        <?php echo $_smarty_tpl->getSubTemplate ("podbor_char_sumka.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array(), 0);
?>

    <?php } elseif ($_smarty_tpl->tpl_vars['shop']->value == 'platok') {?>
        <?php echo $_smarty_tpl->getSubTemplate ("podbor_char_platok.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array(), 0);
?>
...
if ((isset($_smarty_tpl->tpl_vars['__foreach_icategory']->value['index']) ? $_smarty_tpl->tpl_vars['__foreach_icategory']->value['index'] : null)%3 == 0) {?> style="clear: both"<?php }?>><a href="<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
...
<?php } else { ?>
    <?php if ($_GET['not_detailed_catalog'] != 1 && $_smarty_tpl->tpl_vars['open_category_id']->value != 790 && $_smarty_tpl->tpl_vars['open_category_parent_id']->value != 790 && $_smarty_tpl->tpl_vars['is_find']->value != 1 && $_smarty_tpl->tpl_vars['is_brand']->value != 1) {?>
        <?php echo $_smarty_tpl->getSubTemplate ("podbor_char.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array(), 0);
?>
...
<?php if ($_smarty_tpl->tpl_vars['products']->value[0]) {?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['shop']->value == 'lady' || $_smarty_tpl->tpl_vars['shop']->value == 'woman') {?>
        <?php echo $_smarty_tpl->getSubTemplate ("navigation.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array(), 0);
?>

        <?php echo '/*%%SmartyNocache:122227793155f574fb31dcc9_44490337%%*/<?php echo $_smarty_tpl->getSubTemplate ((($tmp = @$_smarty_tpl->tpl_vars[\'template_products_catalog\']->value)===null||$tmp===\'\' ? \'getProductLady.tpl\' : $tmp), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 1, $_smarty_tpl->cache_lifetime, array(), 0);
?>
/*/%%SmartyNocache:122227793155f574fb31dcc9_44490337%%*/';?>
...
?>
            ...
            <?php echo '/*%%SmartyNocache:122227793155f574fb31dcc9_44490337%%*/<?php echo $_smarty_tpl->getSubTemplate ((($tmp = @$_smarty_tpl->tpl_vars[\'template_products_catalog\']->value)===null||$tmp===\'\' ? \'getProduct.tpl\' : $tmp), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 1, $_smarty_tpl->cache_lifetime, array(), 0);
?>
/*/%%SmartyNocache:122227793155f574fb31dcc9_44490337%%*/';?>
...
" <?php if ($_smarty_tpl->tpl_vars['product_characteristic_id']->value == 2) {?>цвет<?php }?></div>
        <?php echo '/*%%SmartyNocache:122227793155f574fb31dcc9_44490337%%*/<?php echo $_smarty_tpl->getSubTemplate ((($tmp = @$_smarty_tpl->tpl_vars[\'template_products_catalog\']->value)===null||$tmp===\'\' ? \'getProduct.tpl\' : $tmp), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 1, $_smarty_tpl->cache_lifetime, array(\'products\'=>$_smarty_tpl->tpl_vars[\'product_in_chars\']->value,\'product_images\'=>$_smarty_tpl->tpl_vars[\'product_in_char_images\']->value), 0);
?>
/*/%%SmartyNocache:122227793155f574fb31dcc9_44490337%%*/';?>
...
">&nbsp;</div>
    ...
    <div id="sorting_pages" style="display: none"><?php echo $_smarty_tpl->getSubTemplate ('navigation_pages.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array('is_scrool'=>1), 0);
?>
</div>
    <div class="clear"></div>
