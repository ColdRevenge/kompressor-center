<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-08-19 14:52:33
         compiled from "/home/lalipop/domains/lalipop.ru/public_html/modules/catalog/templates/catalog_mobile.tpl" */ ?>
<?php /*%%SmartyHeaderCode:111359376755d46e01083ea0-17700894%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4daff5275384874298af240a6b5dc393907ea45f' => 
    array (
      0 => '/home/lalipop/domains/lalipop.ru/public_html/modules/catalog/templates/catalog_mobile.tpl',
      1 => 1435848956,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '111359376755d46e01083ea0-17700894',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55d46e01331e51_34708031',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55d46e01331e51_34708031')) {function content_55d46e01331e51_34708031($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/lalipop/domains/lalipop.ru/public_html/lib/smarty/plugins/modifier.replace.php';
...
?>
            <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['bread']['iteration']==$_smarty_tpl->getVariable('smarty')->value['foreach']['bread']['total']-1) {?>
...
?>
            <?php if ($_smarty_tpl->tpl_vars['bread_catalog']->value['link']&&$_smarty_tpl->getVariable('smarty')->value['foreach']['name']['iteration']==$_smarty_tpl->getVariable('smarty')->value['foreach']['name']['total']-1) {?>
...
/"><?php echo stripslashes($_smarty_tpl->tpl_vars['icategory']->value->name);?>
 от производителя <?php echo stripslashes($_smarty_tpl->tpl_vars['icategory']->value->brand_name);?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['products']->value[0]) {?>
                <?php echo $_smarty_tpl->getSubTemplate ("navigation_mobile.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

                

                <?php if ($_smarty_tpl->tpl_vars['shop']->value=='lady') {?>
                    <?php echo $_smarty_tpl->getSubTemplate ('getProductMobileLady.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

                <?php } else { ?>
                    <?php if ($_smarty_tpl->tpl_vars['open_category_id']->value!=790&&$_smarty_tpl->tpl_vars['open_category_id']->value!=823) {?>
                        <?php echo $_smarty_tpl->getSubTemplate ('getProductMobile.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
