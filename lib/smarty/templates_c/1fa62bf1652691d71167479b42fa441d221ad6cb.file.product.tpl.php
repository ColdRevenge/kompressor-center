<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-09-11 20:39:08
         compiled from "/home/lalipop/domains/lalipop.ru/private_html/modules/products/templates/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20803729455d46946e19ad1-50320609%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1fa62bf1652691d71167479b42fa441d221ad6cb' => 
    array (
  ...
  'nocache_hash' => '20803729455d46946e19ad1-50320609',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_55d46947270877_24945876',
  'variables' => 
  array (
    'is_mobile' => 0,
    'shop' => 0,
...
<?php if ($_valid && !is_callable('content_55d46947270877_24945876')) {function content_55d46947270877_24945876($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/lalipop/domains/lalipop.ru/public_html/lib/smarty/plugins/modifier.replace.php';
?><?php if ($_smarty_tpl->tpl_vars['is_mobile']->value==1) {?>
    <?php echo $_smarty_tpl->getSubTemplate ("productMobile.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

<?php } else { ?>
    <?php if ($_smarty_tpl->tpl_vars['shop']->value=='lady'||$_smarty_tpl->tpl_vars['shop']->value=='woman') {?>
        <?php echo $_smarty_tpl->getSubTemplate ("productLady.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
/"><?php echo stripslashes($_smarty_tpl->tpl_vars['news']->value->name);?>
                                                                ...
                                                                <?php }?>
                                                                <?php echo $_smarty_tpl->getSubTemplate ('collection_product.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('products'=>$_smarty_tpl->tpl_vars['collection']->value), 0);?>
                                                                ...
                                                                <?php echo $_smarty_tpl->getSubTemplate ('like_product.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('products_in_category'=>$_smarty_tpl->tpl_vars['complect_products']->value,'type'=>"2"), 0);?>
