<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-08-20 17:08:04
         compiled from "/home/lalipop/domains/lalipop.ru/public_html/modules/users/templates/admin_add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:49895250755d5df4442cc74-00753275%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7361e6216772f012ef1b62636331bdf4cf6a745c' => 
    array (
      0 => '/home/lalipop/domains/lalipop.ru/public_html/modules/users/templates/admin_add.tpl',
      1 => 1439727788,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '49895250755d5df4442cc74-00753275',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55d5df446e91e8_45572135',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55d5df446e91e8_45572135')) {function content_55d5df446e91e8_45572135($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/lalipop/domains/lalipop.ru/public_html/lib/smarty/plugins/modifier.replace.php';
?><?php echo '<script'; ?>
...
" placeholder="Стартовая страница" name="start_access_link" style="width: 230px;" />
 ...
 $_from = $_smarty_tpl->tpl_vars['access']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
$_smarty_tpl->tpl_vars["access_item"]->_loop = true;
 $_smarty_tpl->tpl_vars["key_3"]->value = $_smarty_tpl->tpl_vars["access_item"]->key;
?>
 ...
 $_from = $_smarty_tpl->tpl_vars['my_access']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
$_smarty_tpl->tpl_vars["my_item"]->_loop = true;
 $_smarty_tpl->tpl_vars["my_order"]->value = $_smarty_tpl->tpl_vars["my_item"]->key;
$_smarty_tpl->tpl_vars["my_item_2"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["my_item_2"]->_loop = false;
 $_smarty_tpl->tpl_vars["my_key_2"] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['my_item']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["my_item_2"]->key => $_smarty_tpl->tpl_vars["my_item_2"]->value) {
$_smarty_tpl->tpl_vars["my_item_2"]->_loop = true;
 $_smarty_tpl->tpl_vars["my_key_2"]->value = $_smarty_tpl->tpl_vars["my_item_2"]->key;
if ($_smarty_tpl->tpl_vars['key_2']->value==$_smarty_tpl->tpl_vars['my_key_2']->value) {
$_smarty_tpl->tpl_vars["my_access_item"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["my_access_item"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['my_item_2']->value['access']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["my_access_item"]->key => $_smarty_tpl->tpl_vars["my_access_item"]->value) {
...
' maxlength="255" style="width: 280px;"/></td>
    ...
    <?php if ($_smarty_tpl->tpl_vars['is_coupon']->value==1) {?>
        <tbody id="coupon_tbody">
            <?php echo $_smarty_tpl->getSubTemplate ("user_coupon.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
