    ...
    public function getFilesAction() {
        ...
        switch ($this->action_id) {
            case 7:  //Акшен для модуля баннеры
                $this->act_url = $this->admin_url . 'banners/edit/#img_id#/';
                break;
        }
//echo $this->action_id;
    ...
    public function uploaderAction() {
        ...
        switch ($this->action_id) {
            case 7:  //Акшен для модуля баннеры
                ...
                $this->act_height = (isset($registry->up_action_height) ? $registry->up_action_height : '300px');
                break;
        }
...
// to pass data through iframe you will need to encode all html tags
        ...
        try {
            if ($uploader->getUploadName()) {//Если файл залит
                ...
                if (($width > 0 || $height > 0) && $is_image != false) { //Изменения размеров главной фотографии
                    $this->_setResize($upload_dir . $uploader->getUploadName(), $upload_dir . $uploader->getUploadName(), $width, $height);
                }
